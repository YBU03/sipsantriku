...
Logo (folder arsip berkubah dengan bulan sabit, santri, dan kitab terbuka) ada di `public/`:

| Berkas | Dipakai untuk |
| --- | --- |
| `icon-192.png`, `icon-512.png` | Ikon PWA (manifest) |
| `icon-maskable-512.png` | Ikon adaptif Android (latar penuh, logo di zona aman) |
| `apple-touch-icon.png` | Ikon layar utama iOS (180×180, tanpa transparansi) |
| `favicon.ico`, `favicon.png` | Ikon tab browser |
